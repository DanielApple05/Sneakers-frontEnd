  ...
  useEffect(() => {
    const fetchSneaker = async () => {
      ...
      try {
        ...
        if (!res) return <p className="p-4 text-red-500">Sneaker not found!</p>;
        ...
        <div className="xl:max-w-2xl max-w-full mx-auto bg-[#f5d19f] p-6 shadow-lg xl:my-10 my-0 rounded text-gray-700 xl:flex grid gap-5">
          {loading ? (
                ...
                <div className="flex justify-between">
                  <div className="flex space-x-3">
                    {Array.from({ length: 3 }).map((_, p) => (
                      <div key={p} className="w-8 h-8 bg-gray-400 rounded" />))}
                  </div>
                  <div className="h-8 w-18 bg-gray-400 rounded-lg" />
                </div>
                <div className="flex justify-between">
            ...
            <>
              ...
              <div className="text-[12px] w-full grid gap-y-2">
