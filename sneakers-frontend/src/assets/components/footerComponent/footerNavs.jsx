        ...
        <div className=" flex justify-between px-20 pb-10">
          ...
          <div className=" grid w-[30%] ">
            ...
            <div className=" bg-white rounded overflow-hidden mb-3 ">
              <form onSubmit={handleSubmit} className="flex mt-5 h-7 ">
                <input
                  type="email"
                ...
                />
                <button type="submit" className="bg-red-700 hover:bg-red-800 text-white px-2 py-1 text-sm font-semibold tracking-wide transition rounded-l cursor-pointer hover:translate-x-1">
                  Subscribe
                </button>
              </form>
            </div>
        ...
        <div className="flex gap-x-5 ">
          {
            FtNavBtns.brandIcon.map((brand) => (
              <img key={brand} src={brand} alt="" className="w-10 rounded" />
